  ...
  render() {
    ...
    let minus = (
      <img
        src={minusIcon}
        alt="minus"
        style={{ width: "25px", height: "8px", marginBottom: "8px" }}
      ></img>
    );
    let plus = (
      <img
      ...
      >
        ...
        <section className={classes.PassengerChangeHead}>
          <span
            ...
            onClick={this.passengerChangeCancelHandler}
          >
            {"<"}
          </span>
        ...
        <section className={classes.PassengerChangeBody}>
          <Button
            role="button"
          ...
          <span aria-hidden="true">
            ...
            {this.state.adultsCount === 1 ? "Adult" : "Adults"}
          </span>
          <Button
            role="button"
          ...
          <span aria-hidden="true">
            ...
            {this.state.childrenCount === 1 ? "Child" : "Children"}
          </span>
          <Button
            role="button"
          ...
          <span aria-hidden="true">
            ...
            {this.state.infantsCount === 1 ? "Infant" : "Infants"}
          </span>
          <Button
            role="button"
