...
class SearchInput extends Component {
  ...
  inputChangeHandler = e => {
    ...
    if (this.state.inputValue) {
      this.props.id === "departure"
        ? this.props.sendDepartureInputValue(searchText)
        : this.props.sendArrivalInputValue(searchText);
    }
  };
  ...
  suggestionClickedHandler = suggestion => {
    ...
    if (this.state.inputValue) {
      this.props.id === "departure"
        ? this.props.sendDepartureInputValue(suggestion)
        : this.props.sendArrivalInputValue(suggestion);
    }
  };
    ...
    if (suggestions.length > 0 && this.state.onChange) {
      return (
        <ul
          ...
          style={{
            width:
              this.state.onChange && window.screen.width < 1024
                ? "100%"
                : `${document.getElementById("departure").offsetWidth}px`,
            height:
              this.state.onChange && window.screen.width < 1024
                ? "100%"
                : "240px",
            overflowY:
              this.state.onChange && window.screen.width < 1024
                ...
                : "scroll",
            paddingTop:
              this.state.onChange && window.screen.width < 1024 ? "5%" : "5px",
            left:
              this.state.onChange && window.screen.width < 1024 ? "0" : "unset"
          }}
        >
        ...
        style={{
          ...
          position:
            this.state.onChange && window.screen.width < 1024
              ...
              : "relative",
          top:
            this.state.onChange && window.screen.width < 1024 ? "0" : "initial",
          zIndex:
            this.state.onChange && window.screen.width < 1024
              ? "2500"
              : "initial"
      ...
      >
        ...
        <input
          ...
          style={{
            ...
            borderRadius:
              this.state.onChange && window.screen.width < 1024 ? "0" : "6px",
            ...
            zIndex:
              this.state.onChange && window.screen.width < 1024
                ...
                : "unset",
            top:
              this.state.onChange && window.screen.width < 1024 ? "0" : "none",
            left:
              this.state.onChange && window.screen.width < 1024 ? "0" : "unset"
          }}
        />
